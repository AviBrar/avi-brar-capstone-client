...
export default function AddTeam() {
  ...
  const isFormValid = (event) => {
    ...
    for (let i = 0; i < states.length; i++) {
      ...
      if (states[i] === "") {
        //Enters on invalid type="text" input fields
        inputs[i].classList.add("--invalid");
        bool = false;
      } else if (states[i] === "invalid") {
        //Enters on unselected select input fields
        inputs[i].classList.add("--invalid");
        bool = false;
      } else if (typeof states[i] === "number" && i === 3 && states[i] <= 0) {
        //Enters only for the quantity field
        inputs[i].classList.add("--invalid");
        bool = false;
      } else if (
        (states[i] === false && states[i + 1] === false) ||
        (states[i] === false && states[i - 1] === false)
      ) {
        //Enters only for the radio fields
        inputs[i].classList.add("--invalid");
        bool = false;
      }
    }
        ...
        <section className="new-team__details">
          ...
          <div className="new-team__details-info">
            ...
            <select
              id="teamCountry"
              name="teamCountry"
              className="new-team__details-country"
          ...
          <div className="new-team__details-info">
            ...
            <select
              name="teamLeague"
              id="teamLeague"
              className="new-team__details-text dropdown"
